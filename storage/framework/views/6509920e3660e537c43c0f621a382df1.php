...
<html>
  <head>
    ...
    <title><?php echo e($data->name); ?> <?php echo e($data->surname); ?></title>
  ...
  <body class="geniko">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="/"><?php echo e($data->name); ?> <?php echo e($data->surname); ?></a>
...
<section class="hero-section">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6">
        <h1 class="hero-title">Καλως ήρθες στην σελίδα μου <?php echo e($data->name); ?> <?php echo e($data->surname); ?></h1>
        <div class="fade-in-text">
        <p class="hero-text">Ένα Hero Section για ήρωες δεξιά σου. </p>
</div>
        <button onclick="location.href='<?php echo e(url('http://milesome.com/damo/second-task/app%20%281%29/public/about')); ?>'"><span>Σχετικά με μένα</span><i></i></button>
      </div>
      <div class="col-md-6">
...
</html><?php /**PATH /home/commilesome/public_html/damo/second-task/app (1)/resources/views/dashboard.blade.php ENDPATH**/ ?>